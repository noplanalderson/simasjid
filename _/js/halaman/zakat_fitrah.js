    ...
    $(document).ready(function(){
        ...
        var table = $('#tblZakatFitrah').DataTable(dtOptions);
    ...
    $(function(){
        $('.tambah-zakat').on('click', function() {
        	$('.modal-title').html('Tambah Data');
            $('.modal-footer button[type=submit]').html('Tambah');
            $('.modal-body form').attr('action', baseURI + '/tambah-zakat-fitrah');
        ...
        $("#tblZakatFitrah").on('click', '.edit-zakat', function(){
            $('.modal-title').html('Edit Data');
            $('.modal-footer button[type=submit]').html('Edit');
            $('.modal-body form').attr('action', baseURI + '/edit-zakat-fitrah');

            const hash = $(this).data('id');
            $.ajax({
                url: baseURI + '/get-zakat-fitrah',
                data: {
                        kode_transaksi: hash, 
        ...
        $("#tblZakatFitrah").on('click', '.log-zakat', function(){
            $('.modal-title').html('Log Zakat Fitrah');

            const hash = $(this).data('id');
            $.ajax({
                url: baseURI + '/log-zakat-fitrah',
                data: {
                        kode_transaksi: hash, 
                        simasjid_token: $('meta[name="X-CSRF-TOKEN"]').attr('content')
                    },
    ...
    $("#tblZakatFitrah").on('click', '.delete-btn', function(e){
      e.preventDefault();
        ...
        if (result.value == true) {
            ...
            $.ajax({
                url: baseURI + '/hapus-zakat-fitrah',
                data: { 
                    kode_transaksi: hash,
                    simasjid_token: $('meta[name="X-CSRF-TOKEN"]').attr('content')
                },
