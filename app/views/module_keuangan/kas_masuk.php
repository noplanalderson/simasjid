              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title float-left mt-3">Daftar Pemasukan</h4>
                      ...
                      <table class="table table-striped table-bordered w-100" id="tblKeuangan">
                        ...
                        <?php foreach ($daftar_kas as $kas) :?>
                            <tr>
                                ...
                                <td><?= ($kas->pemasukan === null) ? '-' : rupiah($kas->pemasukan) ?></td>
                                <td>
                                  <div class="dropdown">
              ...
              <div class="row">
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input type="text" id="pemasukan" name="pemasukan" class="form-control" placeholder="0.0" pattern="^([0-9.]+)" required="required">
                      </div>
                  </div>
              </div>
              <div class="row">
